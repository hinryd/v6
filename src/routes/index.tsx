...
import { ExternalLink, Github, Globe, Instagram, Mail } from "lucide-react"
    ...
    const projects = [
        {
            title: "Fiona",
            description:
                "A Telegram group helper bot, see who's the most active member!",
            href: "https://t.me/fiona_group_admin_bot",
            tags: [
                {
            ...
            screenshot: FionaImage,
            isActive: true,
        },
        {
            title: "hackernews",
            description:
                "A sleek hacker news client with split view and dark mode, I use it everyday!",
        ...
        },
        {
            title: "Brawl King",
            description:
                "A quick peek to the stats for each map in Brawl Stars",
        ...
        },
        {
            ...
            description:
                "A simple implementation of the famous zero-players game!",
    ...
    const posts = [
        {
            ...
            summary:
                "Thoughts on content-first design and performance on mobile.",
            href: "#",
            date: "2025-08-21",
            emoji: "🎨",
        },
        {
            ...
            summary:
                "What makes AI tooling feel magical and trustworthy? My notes.",
            href: "#",
            date: "2025-05-03",
            emoji: "🤖",
        },
    ...
    return (
        <main className="mx-auto max-w-xl px-4 pb-16 pt-8">
            ...
            <div className="relative">
                <div
                    id="projects"
                    className="absolute -top-20 h-0 w-0"
                    aria-hidden
                />
                <div
                    id="experience"
                ...
                <TabsContent value="projects" className="mt-4 space-y-3">
                    {projects.map((p) => (
                        <a
                            ...
                            key={p.title}
                        >
                            <Card className="text-left overflow-hidden flex-row p-0 gap-0 h-32 cursor-pointer hover:shadow-lg transition-shadow">
                                ...
                                <div className="flex flex-1 flex-col justify-between py-3">
                                    <CardHeader className="pb-1 px-4 gap-0.5">
                                        <CardTitle className="text-md leading-tight flex items-center gap-1">
                                            {p.title}
